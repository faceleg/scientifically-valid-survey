...
node_modules/.bin/istanbul cover --dir coverage/server node_modules/.bin/_mocha -- -w --timeout 5000 --recursive --reporter spec test/server/configure.js test/server/
